myAdd=function(x,y){
	data <- read.csv(file = "/home/orienit/sample.csv")
	b=2000
	a=b-6
	resA=list()
	for(i in a:b){
	...
	write.csv(mydata,file = "/home/orienit/MyData3.csv")
	...
	for (k in 2:15) {
	  datatest <- read.csv(file = "/home/orienit/MyData3.csv")
	  ...
	  write.csv(big,"/home/orienit/MyData3.csv")
	}
return(b)
}
